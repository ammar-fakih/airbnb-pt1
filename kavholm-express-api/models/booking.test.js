  ...
  describe('Test createBooking', () => {
    test('Can create a new booking with valid params', async () => {
      ...
      const newBooking = {
        ...
        endDate: new Date('03-06-2021'),
        guests: 2,
      };
      const createdBooking = Booking.createBooking(newBooking, user, listing);
    ...
    test('Throws error with invalid params', async () => {
      ...
      const newBooking = { endDate: '03-06-2021' };

      try {
        const createdBooking = Booking.createBooking(newBooking, listing, user);
      } catch (e) {
